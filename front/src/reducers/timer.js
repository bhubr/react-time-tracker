...
const timerReducer = (state = initialState, action) => {
  switch(action.type) {
    ...
    case TIMER_STARTED: {
      ...
      return { ...state, startedAt, interval, remaining: DURATION, duration: DURATION }
    }
    ...
    case BREAK_STARTED: {
      ...
      consecutivePomos = consecutivePomos % 4
      return { ...state, startedAt, interval, remaining, consecutivePomos, duration, status }
    }
